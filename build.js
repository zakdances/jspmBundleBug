...
System.registerDynamic("npm:jquery@3.0.0-beta1.json", [], false, function() {
  return {
    "main": "dist/jquery.js",
    "format": "cjs",
    "meta": {
...
System.registerDynamic("npm:jquery@3.0.0-beta1/dist/jquery.js", ["process"], true, function($__require, exports, module) {
    ...
    function showHide(elements, show) {
      ...
      for (; index < length; index++) {
        ...
        if (show) {
          ...
          if (elem.style.display === "" && jQuery.css(elem, "display") === "none" && jQuery.contains(elem.ownerDocument, elem)) {
...
System.registerDynamic("github:websanova/js-url@2.3.0.json", [], false, function() {
  return {
    "main": "url.js"
  };
});

System.registerDynamic("github:websanova/js-url@2.3.0/url.js", [], false, function($__require, $__exports, $__module) {
  ...
  (function() {
    ...
    if (typeof jQuery !== 'undefined') {
      jQuery.extend({url: function(arg, url) {
...
System.register("app/app.ts", ["jquery", "js-url"], function(exports_1, context_1) {
  "use strict";
      ...
      jquery_1.default(function() {
        ...
        setInterval(function() {
          window.document.requestsMade.forEach(function(v, i, a) {
            ...
            var filename = js_url_1.default('file', v.responseURL);
            if (scriptsToWatchFor.hasOwnProperty(filename) && scriptsToWatchFor[filename] === false) {
              jquery_1.default('#content').append("<h1>" + filename + " has been requested.</h1>");
